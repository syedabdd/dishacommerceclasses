                    ...
                    <tr key={doubt.id} className="hover:bg-gray-50/80 transition-colors">
                      ...
                      <td className="p-5 text-center">
                        <div className="relative inline-block text-left group">
                          ...
                          <div className="absolute z-10 hidden group-hover:block w-32 bg-white rounded-xl shadow-lg border border-gray-100 py-1 right-0 top-full mt-1">
                            <button
                              onClick={() => handleStatusUpdate(doubt.id, "Pending")}
                            ...
                            <button
                              onClick={() => handleStatusUpdate(doubt.id, "Resolved")}
                              className="w-full text-left px-4 py-2 text-xs font-medium text-emerald-600 hover:bg-emerald-50 flex items-center gap-2 transition-colors"
                            >
