        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          ...
          >
            <div className="relative w-full max-w-[480px]">
              ...
              >
                ...
                <Image
                  src="/welcome.webp"
                  alt="Disha Commerce Classes Classes"
          ...
          >
            ...
            <motion.p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Best Online Classes for Class 11th & 12th Commerce (BSEB Bihar
              Board) for Bihar Students. Learn Accountancy, Business Studies, Economics &
              Mathematics from expert faculty through live classes, smart study
            ...
            >
              <FeatureCard
                ...
                bg="bg-red-50"
                title="Expert Commerce Faculties"
                desc="Learn Accountancy, Business Studies and Economics from experienced mentors."
              />
              <FeatureCard
                index={1}
              ...
              <FeatureCard
                ...
                desc="Producing Bihar Board Commerce toppers year after year."
              />
            </motion.div>
            ...
            >
              ...
              >
                <SocialButton
                  ...
                  text="YouTube"
                  to="https://www.youtube.com/@dishacommerceclasses"
                />
                <SocialButton
                  index={2}
