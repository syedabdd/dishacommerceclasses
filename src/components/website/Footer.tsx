...
const Footer = () => {
  ...
  const socials = [
    ...
    },
    {
      Icon: TelegramIcon,
      label: "Telegram",
      url: "https://t.me/dishacommerceclasses",
      color: "#229ed9",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(15,23,42,0.22) 0%, transparent 70%)",
        }}
      />
      <div
      ...
      >
        <div className="max-w-7xl text-gray-200 mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
